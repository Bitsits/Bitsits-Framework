...
namespace BitSits_Framework
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        protected float menuTitleSize = 50;
        ...
        public override void HandleInput(InputState input)
        {
            ...
            else if (mouseOver && input.IsMouseLeftButtonClick())
            {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (titleTexture == null)
                spriteBatch.DrawString(ScreenManager.GameContent.gameFont, menuTitle,
                    titlePosition, titleColor, 0, Vector2.Zero,
                    menuTitleSize / ScreenManager.GameContent.gameFontSize,
