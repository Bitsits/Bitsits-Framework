...
namespace Box2D.XNA
{
    ...
    public class BodyDef
    {
        ...
        /// <summary>
        /// Should this body be prevented from rotating? Useful for characters.s
        /// </summary>
    ...
    public class Body
    {
        ...
        /// </summary>
        /// <param name="w">omega the new angular velocity in radians/second.</param>
        ...
        /// </summary>
        /// <returns>true if the body is sleeping.</returns>
        public bool IsAwake()
        {
